...
SystemBuilder::SystemBuilder(double _epsilon, double _dt):
...
//currently unused
void SystemBuilder::putLinearSpring(__attribute__ ((unused)) unsigned n1,__attribute__ ((unused)) unsigned n2) {
...
void SystemBuilder::putWormLikeSpring(unsigned n1, unsigned n2) {
...
unsigned SystemBuilder::addNode(__attribute__ ((unused)) double mass, glm::dvec3 pos ) {
...
//add platelets
//all node pointers made here. We take this opportunity to
unsigned SystemBuilder::addPlt(__attribute__ ((unused)) double pltmass, glm::dvec3 pos ) {
...
//fix platelet
void SystemBuilder::fixPlt(unsigned id) {
...
std::shared_ptr<System> SystemBuilder::create() {
	...
	std::shared_ptr<System> host_ptr_devNodeSystem = std::make_shared<System>();
